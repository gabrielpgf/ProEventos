...
namespace ProEventos.Application
{
    public class AccountService : IAccountService
    {
        ...
        public async Task<SignInResult> CheckUserPasswordAsync(UserUpdateDto userUpdateDto, string password)
        {
            ...
            {
                throw new Exception($"Erro ao tentar verificar senha de usuário. Erro: {e.Message}");
            }
        }
        ...
        public async Task<UserUpdateDto> GetUserByUserNameAsync(string userName)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception($"Erro ao tentar retornar usuário pelo Username. Erro: {e.Message}");
            }
        }
        ...
        public async Task<UserUpdateDto> UpdateAccount(UserUpdateDto userUpdateDto)
        {
            ...
            catch (Exception e)
            {
                ...
                throw new Exception($"Erro ao tentar atualizar a conta de usuário. Erro: {e.Message}");
            }
        }
